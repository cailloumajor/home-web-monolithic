...
class Slot(models.Model):
    ...
    mon = models.BooleanField(verbose_name="lundi")
    tue = models.BooleanField(verbose_name="mardi")
    wed = models.BooleanField(verbose_name="mercredi")
    thu = models.BooleanField(verbose_name="jeudi")
    fri = models.BooleanField(verbose_name="vendredi")
    sat = models.BooleanField(verbose_name="samedi")
    sun = models.BooleanField(verbose_name="dimanche")
